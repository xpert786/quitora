...
public final class E {
    ...
    public final synchronized int a() {
        ...
        if (this.f12001b == 0) {
            try {
                packageInfoE = C2006f.a(this.f12000a).e("com.google.android.gms", 0);
            } catch (PackageManager.NameNotFoundException e7) {
                Log.w("Metadata", "Failed to find package ".concat(e7.toString()));
                packageInfoE = null;
            }
            if (packageInfoE != null) {
                this.f12001b = packageInfoE.versionCode;
            }
        }
        return this.f12001b;
    }
    ...
    */
    public final synchronized int b() {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f12002c     // Catch: java.lang.Throwable -> L26
            if (r0 == 0) goto L7
            monitor-exit(r5)
            return r0
        L7:
            android.content.Context r0 = r5.f12000a     // Catch: java.lang.Throwable -> L26
            android.content.pm.PackageManager r1 = r0.getPackageManager()     // Catch: java.lang.Throwable -> L26
            k3.e r0 = k3.C2006f.a(r0)     // Catch: java.lang.Throwable -> L26
        ...
        L26:
            ...
            goto L79
        L28:
            boolean r0 = i3.n.e()     // Catch: java.lang.Throwable -> L26
            r2 = 1
            if (r0 != 0) goto L48
        ...
        L48:
            ...
            r2 = r1
        L62:
            r5.f12002c = r2     // Catch: java.lang.Throwable -> L26
            monitor-exit(r5)
            return r2
        L66:
            java.lang.String r0 = "Metadata"
        ...
        L79:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: a3.E.b():int");
    }
}

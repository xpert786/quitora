...
public abstract class b {
    public static final Bundle a(C1980o... c1980oArr) {
        Bundle bundle = new Bundle(c1980oArr.length);
        for (C1980o c1980o : c1980oArr) {
            String str = (String) c1980o.a();
            Object objB = c1980o.b();
            if (objB == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    r.e(objB, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) objB);
                } else if (String.class.isAssignableFrom(componentType)) {
                    r.e(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) objB);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    r.e(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");

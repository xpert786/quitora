    ...
    public final boolean A(int i7, int i8) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == AbstractC1769f.f19587F) {
                    view = childAt;
                } else if (id == AbstractC1769f.f19598k) {
                    view2 = childAt;
                } else {
                    if ((id != AbstractC1769f.f19600m && id != AbstractC1769f.f19602o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i11 = paddingTop - iZ;
            int iMin = Math.min(i10, measuredHeight);
            if (iMin > 0) {
                i10 -= iMin;
                iZ += iMin;
            }
            view2.measure(i7, View.MeasureSpec.makeMeasureSpec(iZ, 1073741824));

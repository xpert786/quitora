...
public abstract class L {
    ...
    public static final char[] f13082a;
    ...
    public static void d(StringBuilder sb, int i7, String str, Object obj) {
        ...
        if (obj instanceof AbstractC1256f) {
            sb.append(": \"");
            sb.append(d0.a((AbstractC1256f) obj));
            sb.append('\"');
            return;
        }
        if (obj instanceof AbstractC1269t) {
            sb.append(" {");
            e((AbstractC1269t) obj, sb, i7 + 2);
            sb.append("\n");
            a(i7, sb);
            sb.append("}");
            return;
    ...
    */
    ...
    public static String f(J j7, String str) {
        StringBuilder sb = new StringBuilder();
        sb.append("# ");
        sb.append(str);
        e(j7, sb, 0);

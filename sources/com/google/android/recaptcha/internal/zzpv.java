...
final class zzpv {
    ...
    public static String zzd(byte[] bArr, int i7, int i8) throws zznn {
        int i9;
        ...
        while (i7 < i10) {
            ...
            if (zzpt.zzd(b9)) {
                ...
                if (b9 < -32) {
                    ...
                    int i14 = i7 + 2;
                    i7 += 3;
                    zzpt.zzb(b9, bArr[i13], bArr[i14], cArr, i12);
                } else {
                    if (i13 >= i10 - 2) {
                        throw new zznn("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b12 = bArr[i7 + 2];
                    i7 += 4;
                    zzpt.zza(b9, b11, b12, bArr[i15], cArr, i12);
                    i12 += 2;
                }
                i12 = i9;
            }

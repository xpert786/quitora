...
final class zzpt {
    public static /* bridge */ /* synthetic */ void zza(byte b8, byte b9, byte b10, byte b11, char[] cArr, int i7) throws zznn {
    ...
    */
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b8, byte b9, char[] cArr, int i7) throws zznn {
        if (b8 < -62 || zze(b9)) {
            throw new zznn("Protocol message had invalid UTF-8.");
        }

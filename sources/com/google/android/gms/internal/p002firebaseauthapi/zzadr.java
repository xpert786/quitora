...
public final class zzadr {
    ...
    */
    public static K3.m zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadr.zza(com.google.android.gms.common.api.Status):K3.m");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0996q) {
            return ((C0996q) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof C0996q) {
            return ((C0996q) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0996q) {
            return ((C0996q) exc).a().endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }

    public static m zza(Status status, AbstractC0983h abstractC0983h, String str, String str2) {
        int I7 = status.I();
        if (I7 != 17012 && I7 != 17007 && I7 != 17025) {
            return zza(status);
        }
        return new C1002x(zza(I7), zza(zzb(I7), status)).d(abstractC0983h).e(str);
    }

    public static C0999u zza(FirebaseAuth firebaseAuth, zzzs zzzsVar, A a8) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzzsVar);
        Pair<String, String> pair = zza.get(17078);
        return new C0999u((String) pair.first, (String) pair.second, C1033o.M(zzzsVar, firebaseAuth, a8));
    }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof C0996q) {
            return ((C0996q) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}

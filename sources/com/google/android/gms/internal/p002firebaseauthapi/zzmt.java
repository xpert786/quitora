...
public final class zzmt {
    ...
    private static zzms zza(zzms zzmsVar, zzms zzmsVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod3 = zzmsVar.zzb.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzmsVar2.zzb.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zzmsVar.zzc.multiply(zzmsVar2.zzd).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zzmsVar2.zzc.multiply(zzmsVar.zzd).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zzms.zza : zza(zzmsVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger bigIntegerAdd = zzmsVar.zzd.add(zzmsVar2.zzd);
        return new zzms(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
    ...
    private static zzms zza(zzms zzmsVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerAdd = zzmsVar.zzb.add(bigIntegerMod2);
        ...
        BigInteger bigIntegerAdd3 = zzmsVar.zzc.add(zzmsVar.zzd);
        return new zzms(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }
    ...
    private static zzms zza(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger bigIntegerMod = new BigInteger(1, zzpp.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zzms(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        if (bigInteger.signum() == 1) {
            if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                ...
                zzms zzmsVarZza = zza(ECPoint.POINT_INFINITY, bigIntegerZza);
                zzms zzmsVarZza2 = zza(generator, bigIntegerZza);
                for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
                    if (bigInteger.testBit(iBitLength)) {
                        zzmsVarZza = zza(zzmsVarZza, zzmsVarZza2, a8, bigIntegerZza);
                        zzmsVarZza2 = zza(zzmsVarZza2, a8, bigIntegerZza);
                    } else {
                        zzmsVarZza2 = zza(zzmsVarZza, zzmsVarZza2, a8, bigIntegerZza);
                        zzmsVarZza = zza(zzmsVarZza, a8, bigIntegerZza);
                    }
                }
                if (zzmsVarZza.zza()) {
                    eCPoint = ECPoint.POINT_INFINITY;
                } else {
                    BigInteger bigIntegerModInverse = zzmsVarZza.zzd.modInverse(bigIntegerZza);
                    BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerZza);
                    eCPoint = new ECPoint(zzmsVarZza.zzb.multiply(bigIntegerMod).mod(bigIntegerZza), zzmsVarZza.zzc.multiply(bigIntegerMod).mod(bigIntegerZza).multiply(bigIntegerModInverse).mod(bigIntegerZza));
                }
                zza(eCPoint, curve);
                return eCPoint;
            }

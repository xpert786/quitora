...
class zzhd extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i9 = 0;
        if (i8 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgz) this.zza[i8]).zza());
            if (iCompareTo > 0) {
                return -(i7 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i9 <= i8) {
            int i10 = (i9 + i8) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgz) this.zza[i10]).zza());
            if (iCompareTo2 < 0) {
                i8 = i10 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i7) {
        zzo();
        Object value = ((zzgz) this.zza[i7]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i8] = new zzgz(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            if (!zzg(i8).equals(zzhdVar.zzg(i8))) {
                return false;
            }
        }
        if (i7 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i7] = new zzgz(this, comparable, obj);
        this.zzb++;
        return null;
    }

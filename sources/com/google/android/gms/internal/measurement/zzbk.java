    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 14) {
            ...
            while (i7 < list.size() - 1) {
                zzap zzapVarZzb3 = zzgVar.zzb((zzap) list.get(i7));
                ...
                zzgVar.zzf(zzapVarZzb3.zzi(), zzgVar.zzb((zzap) list.get(i7 + 1)));
                i7 += 2;
            }
            return zzap.zzf;
        }
        if (iOrdinal == 24) {
            ...
            while (i7 < list.size()) {
                zzapVarZzb4 = zzgVar.zzb((zzap) list.get(i7));
        ...
        if (iOrdinal == 58) {
            ...
            if (!(zzapVarZzb6 instanceof zzal)) {
                return zzapVarZzb8;
            }
        ...
        if (iOrdinal == 18) {
            ...
            while (i7 < list.size() - 1) {
                zzap zzapVarZzb10 = zzgVar.zzb((zzap) list.get(i7));
                zzap zzapVarZzb11 = zzgVar.zzb((zzap) list.get(i7 + 1));

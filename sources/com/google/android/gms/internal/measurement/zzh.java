...
public final class zzh {
    ...
    public static long zzd(double d8) {
        return ((long) zzb(d8)) & 4294967295L;
    }
    ...
    public static void zzh(String str, int i7, List list) {
        if (list.size() != i7) {
    ...
    public static void zzi(String str, int i7, List list) {
        if (list.size() < i7) {
    ...
    public static void zzj(String str, int i7, List list) {
        if (list.size() > i7) {

    ...
    */
    private static boolean zzd(android.content.Context r7) {
        ...
        L6:
            ...
            monitor-enter(r0)
            boolean r2 = com.google.android.gms.internal.measurement.zzji.zzb     // Catch: java.lang.Throwable -> Lf
            if (r2 == 0) goto L11
        ...
        L12:
            ...
            r5 = 0
            if (r2 > r3) goto L4a
            android.os.UserManager r3 = com.google.android.gms.internal.measurement.zzji.zza     // Catch: java.lang.Throwable -> Lf
            if (r3 != 0) goto L25
            ...
            com.google.android.gms.internal.measurement.zzji.zza = r3     // Catch: java.lang.Throwable -> Lf
        L25:
            android.os.UserManager r3 = com.google.android.gms.internal.measurement.zzji.zza     // Catch: java.lang.Throwable -> Lf
            if (r3 != 0) goto L2b
            r5 = r1
        ...
        L3d:
            ...
            com.google.android.gms.internal.measurement.zzji.zza = r4     // Catch: java.lang.Throwable -> Lf
            int r2 = r2 + 1
            goto L12
        L4a:
            if (r5 == 0) goto L4e
        ...
        L4e:
            if (r5 == 0) goto L52
            com.google.android.gms.internal.measurement.zzji.zzb = r1     // Catch: java.lang.Throwable -> Lf
        L52:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> Lf
            return r5
        L54:

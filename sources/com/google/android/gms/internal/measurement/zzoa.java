...
class zzoa extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i9 = 0;
        if (i8 >= 0) {
            int iCompareTo = comparable.compareTo(((zznw) this.zza[i8]).zza());
            if (iCompareTo > 0) {
                return -(i7 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i9 <= i8) {
            int i10 = (i9 + i8) / 2;
            int iCompareTo2 = comparable.compareTo(((zznw) this.zza[i10]).zza());
            if (iCompareTo2 < 0) {
                i8 = i10 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i7) {
        zzo();
        Object value = ((zznw) this.zza[i7]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i8] = new zznw(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            if (!zzg(i8).equals(zzoaVar.zzg(i8))) {
                return false;
            }
        }
        if (i7 != size) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzl >= 0 ? ((zznw) this.zza[iZzl]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzl = zzl(comparable);
        if (iZzl >= 0) {
            return ((zznw) this.zza[iZzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
        ...
        this.zza[i7] = new zznw(this, comparable, obj);
        this.zzb++;
        return null;
    }

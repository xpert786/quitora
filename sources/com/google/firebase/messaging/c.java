...
public class c {
    ...
    public final Bundle f17732a;

    public c(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f17732a = new Bundle(bundle);
    }
    ...
    public int[] e() {
        ...
        try {
            ...
            Log.w("NotificationParams", "LightSettings is invalid: " + jSONArrayC + ". " + e7.getMessage() + ". Skipping setting LightSettings");
            return null;
        } catch (JSONException unused) {
    ...
    public Object[] g(String str) {
        ...
        for (int i7 = 0; i7 < length; i7++) {
            strArr[i7] = jSONArrayC.optString(i7);
        }
        return strArr;
    }
    ...
    public String i(Resources resources, String str, String str2) {
        ...
        try {
            ...
            Log.w("NotificationParams", "Missing format argument for " + z(str2) + ": " + Arrays.toString(objArrG) + " Default value will be used.", e7);
            return null;
        }
    }
    ...
    public String p(String str) {
        return this.f17732a.getString(w(str));
    }
    ...
    public final String w(String str) {
        if (!this.f17732a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f17732a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f17732a);

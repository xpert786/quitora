...
public final class UiConfig$VariableConfig$$serializer implements C {
    ...
    static {
        ...
        C1070b0 c1070b0 = new C1070b0("com.revenuecat.purchases.UiConfig.VariableConfig", uiConfig$VariableConfig$$serializer, 2);
        c1070b0.l("variable_compatibility_map", true);
        c1070b0.l("function_compatibility_map", true);
        descriptor = c1070b0;
    }
    ...
    public S6.b[] childSerializers() {
        S6.b[] bVarArr = UiConfig.VariableConfig.$childSerializers;
        return new S6.b[]{bVarArr[0], bVarArr[1]};
    }

    @Override // S6.a
    public UiConfig.VariableConfig deserialize(V6.e decoder) {
        Map map;
        Map map2;
        int i7;
        r.g(decoder, "decoder");
        ...
        cVarB.c(descriptor2);
        return new UiConfig.VariableConfig(i7, map2, map, (k0) null);
    }
    ...
    @Override // S6.h
    public void serialize(V6.f encoder, UiConfig.VariableConfig value) {
        r.g(encoder, "encoder");
        r.g(value, "value");
        U6.e descriptor2 = getDescriptor();
        V6.d dVarB = encoder.b(descriptor2);
        UiConfig.VariableConfig.write$Self$purchases_defaultsRelease(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }

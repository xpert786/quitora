...
public final class SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$1 extends s implements Function0 {
    ...
    public SubscriberAttributesManager$synchronizeSubscriberAttributesForAllUsers$1$2$1(SubscriberAttributesManager subscriberAttributesManager, String str, Map<String, SubscriberAttribute> map, String str2, G g7, Function0 function0, int i7) {
        super(0);
    ...
    public final void m211invoke() {
        ...
        String str;
        String str2;
        this.this$0.markAsSynced(this.$syncingAppUserID, this.$unsyncedAttributesForUser, AbstractC2112r.g());
        ...
        if (!r.c(this.$currentAppUserID, this.$syncingAppUserID)) {

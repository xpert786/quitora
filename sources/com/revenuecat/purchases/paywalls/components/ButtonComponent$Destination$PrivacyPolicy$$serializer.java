...
public final class ButtonComponent$Destination$PrivacyPolicy$$serializer implements C {
    ...
    static {
        ...
        C1070b0 c1070b0 = new C1070b0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.PrivacyPolicy", buttonComponent$Destination$PrivacyPolicy$$serializer, 2);
    ...
    public ButtonComponent.Destination.PrivacyPolicy deserialize(e decoder) {
        ...
        cVarB.c(descriptor2);
        return new ButtonComponent.Destination.PrivacyPolicy(i7, str, urlMethod, null, null);
    }
    ...
    public void serialize(f encoder, ButtonComponent.Destination.PrivacyPolicy value) {
        ...
        ButtonComponent.Destination.PrivacyPolicy.write$Self$purchases_defaultsRelease(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }

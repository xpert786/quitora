...
public final class UrlSurrogate$$serializer implements C {
    ...
    static {
        ...
        C1070b0 c1070b0 = new C1070b0("com.revenuecat.purchases.paywalls.components.UrlSurrogate", urlSurrogate$$serializer, 2);
    ...
    public UrlSurrogate deserialize(e decoder) {
        ...
        cVarB.c(descriptor2);
        return new UrlSurrogate(i7, str, urlMethod, null, null);
    }
    ...
    public void serialize(f encoder, UrlSurrogate value) {
        ...
        UrlSurrogate.write$Self$purchases_defaultsRelease(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }

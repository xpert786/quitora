...
public final class ButtonComponent$Destination$Url$$serializer implements C {
    ...
    static {
        ...
        C1070b0 c1070b0 = new C1070b0("com.revenuecat.purchases.paywalls.components.ButtonComponent.Destination.Url", buttonComponent$Destination$Url$$serializer, 2);
    ...
    public ButtonComponent.Destination.Url deserialize(e decoder) {
        ...
        cVarB.c(descriptor2);
        return new ButtonComponent.Destination.Url(i7, str, urlMethod, null, null);
    }
    ...
    public void serialize(f encoder, ButtonComponent.Destination.Url value) {
        ...
        ButtonComponent.Destination.Url.write$Self$purchases_defaultsRelease(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }

...
public final class Dimension$Vertical$$serializer implements C {
    ...
    static {
        ...
        C1070b0 c1070b0 = new C1070b0("vertical", dimension$Vertical$$serializer, 2);
    ...
    public Dimension.Vertical deserialize(e decoder) {
        ...
        k0 k0Var = null;
        if (cVarB.w()) {
            horizontalAlignment = (HorizontalAlignment) cVarB.C(descriptor2, 0, HorizontalAlignmentDeserializer.INSTANCE, null);
            ...
            while (z7) {
                ...
                if (iE == -1) {
                    ...
                    horizontalAlignment = (HorizontalAlignment) cVarB.C(descriptor2, 0, HorizontalAlignmentDeserializer.INSTANCE, horizontalAlignment);
                    i8 |= 1;
                } else {
                    if (iE != 1) {
                        throw new j(iE);
        ...
        cVarB.c(descriptor2);
        return new Dimension.Vertical(i7, horizontalAlignment, flexDistribution, k0Var);
    }
    ...
    public void serialize(f encoder, Dimension.Vertical value) {
        ...
        Dimension.Vertical.write$Self$purchases_defaultsRelease(value, dVarB, descriptor2);
        dVarB.c(descriptor2);
    }
